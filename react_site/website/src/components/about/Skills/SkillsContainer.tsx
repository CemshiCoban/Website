...
import ButtonTemplate from '../../templates/ButtonTemplate'; // Adjust the import path if needed
import SkillCategory from './SkillCategory'; // Adjust the import path if needed
